    ...
    <div className='h-screen justify-center flex flex-col items-center gap-40'>
        ...
        <div className="about-section">
         ...
         <div className='whyme relative right-80 sm:ml-40'>
            ...
            <p className='text-4xl text-slate-300 font-bold'>If you've got a project you'd like to work on with me just get in <br/> touch and we can get to work!</p>
            <Link href="/Progress" >
              <button className='mt-8 check-btn hover:text-white' >Contact Now</button>
            </Link>
        </div>
         </div>
    </>
